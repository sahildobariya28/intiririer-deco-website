                  ...
                  <div className="lg:basis-9/12 px-[15px] md:basis-9/12 sm:basis-full basis-full">
                        <div className="map-left 2xl:p-[60px] p-[20px] sm:p-[30px] md:p-[30px] lg:p-[60px]">
                            <div className="flex 2xl:mb-8 mb-5 sm:mb-6 md:mb-8">
                                <div><i className="fa-solid fa-phone 2xl:text-2xl lg:text-2xl text-lg sm:text-xl text-black"></i></div>
                                <div className="2xl:text-xl text-base lg:text-xl text-black 2xl:ml-10 ml-4 sm:ml-5 md:ml-6 font-medium">+91 9104466884<br/>+91 9104466885</div>
                            </div>
                            <div className="flex 2xl:mb-8 mb-5 sm:mb-6 md:mb-8">
                                <div><i className="fa-solid fa-envelope 2xl:text-2xl lg:text-2xl text-lg sm:text-xl text-black"></i></div>
                                <div className="2xl:text-xl text-base lg:text-xl text-black 2xl:ml-10 ml-4 sm:ml-5 md:ml-6 font-medium">info@interiodeco.in</div>
                            </div>
                            <div className="flex 2xl:mb-8 mb-5 sm:mb-6 md:mb-8">
                                <div><i className="fa-solid fa-globe 2xl:text-2xl lg:text-2xl text-lg sm:text-xl text-black"></i></div>
                                <div className="2xl:text-xl text-base lg:text-xl text-black 2xl:ml-10 ml-4 sm:ml-5 md:ml-6 font-medium">www.interiodeco.in</div>
                            </div>
                            <div className="flex">
                                <div><i className="fa-sharp fa-solid fa-location-dot 2xl:text-2xl lg:text-2xl text-lg sm:text-xl text-black"></i></div>
                                <div className="2xl:text-xl text-base lg:text-xl 2xl:leading-8 leading-7 lg:leading-8 text-black 2xl:ml-10 ml-4 sm:ml-5 md:ml-6 font-medium 2xl:max-w-[50%] md:max-w-[58%] max-w-full">47/A, Meldi Industrial Estate, Nr Gota Railway Crossing, Gota,Ahmedabad, Gujarat - 382481</div>
                            </div>
                        </div>
                  </div>
