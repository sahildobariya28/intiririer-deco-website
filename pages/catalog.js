  ...
  return (
    <>
      ...
      <section className="catalog-bg">
        ...
        <h2 className="relative text-white z-[9] font-bold 2xl:text-[50px] 2xl:leading-[65px] text-center text-[38px] leading-[48px]">
          Catalogues
        </h2>
      </section>
      ...
      <section className="2xl:py-[100px]  py-[60px]">
        <div className="xl:px-[15px] sm:px-[15px] px-[15px] md:container mx-auto">
          <div className="">
            <h3 className="2xl:text-3xl font-medium text-[#e0ac26] text-[26px] leading-8">
              Catalouge 1
            </h3>
              ...
              <div className="row">
                <div className="2xl:basis-4/12 md:basis-4/12 sm:basis-6/12 px-[15px] mb-8">
                  ...
                  <div className="2xl:mt-8 mt-5">
                    <h4 className="2xl:text-2xl text-lg text-[#e0ac26] font-medium 2xl:mb-2 xl:mb-2 mb-[5px]">
                      Item 1
                    </h4>
                    <p className="text-lg font-normal">
                      Amet minim mollit nont.
                    </p>
                  </div>
                </div>
                <div className="2xl:basis-4/12 md:basis-4/12 sm:basis-6/12 px-[15px] mb-8">
