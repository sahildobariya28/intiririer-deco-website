    ...
    <>
      <header className="2xl:mt-[50px] sm:mt-[0px] ab-main-navbar sm:bg-white lg:bg-transparent lg:mt-[50px] bg-white">
        <div className="xl:px-[15px] sm:px-[15px] px-[15px] md:container mx-auto">
          <div className="flex sm:justify-between">
            <Link href="/">
              <a className="py-[15px] sm:py-3 bg-white">
                <img
                ...
                <div className="2XL:flex justify-between items-center hidden lg:flex  lg:items-center">
                      ...
                      <a
                        ...
                        className={
                          router.pathname == "/about"
                            ? "active"
                            : "2xl:pl-16 lg:pl-10 pr-5 text-lg text-white hover:text-black"
                        }
                      >
                        About Us
                      </a>
                      ...
                      <a
                        ...
                        className={
                          router.pathname == "/catalog"
                            ? "active"
                            : "2xl:pl-16 pr-5 lg:pl-10 text-lg text-white hover:text-black"
                        }
                      >
                        Catalogues
                      </a>
                  ...
                  <div>
                    <Link href="#get">
                      <a
                        href=""
                        className="get-btn bg-[#c79b2a] text-lg text-white font-normal"
                      >
                        Get a quote
                      </a>
                    </Link>
      ...
      <div className="ab-sticky-navbar">
        <div
          ...
          data-easing2="ease"
          role="banner"
          className="2xl:py-3 xl:py-3 lg:py-3 md:py-4 sm:py-3 py-3 bg-white"
        >
          <div className="xl:px-[15px] sm:px-[15px] px-[15px] md:container mx-auto">
            <div className="flex justify-between items-center">
              ...
              <nav
                role="navigation"
                className="2xl:flex xl:flex lg:flex relative float-right items-center hidden"
              >
                ...
                <Link href="/">
                  <a
                    href=""
                    aria-current="page"
                    className="nav-link link-h text-lg font-normal pl-[66px] lg:pl-[35px] pr-[20px]"
                  >
                    Home
                  </a>
                </Link>
                <Link href="/about">
                  <a
                    href=""
                    className="nav-link link-a text-lg font-normal pl-[66px] lg:pl-[35px] pr-[20px]"
                  >
                    About Us
                  </a>
                </Link>
                <Link href="/catalog">
                  <a
                    href=""
                    className="nav-link link-c text-lg font-normal pl-[66px] lg:pl-[35px] pr-[20px]"
                  >
                    Catalogues
                  </a>
                </Link>
                <Link href="/contact">
                  <a
                    href=""
                    className="nav-link text-lg font-normal pl-[66px] pr-[20px] lg:pl-[35px] link-s"
                  >
                    Contact Us
                  </a>
                </Link>
                <Link href="#get">
                  <a href="" className="get-new">
                    Get a quote
                  </a>
                </Link>
              </nav>
